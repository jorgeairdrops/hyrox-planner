...
const WODS = {
  ...
  w1: [
    ...
    {type:"upper", title:"UPPER BODY — Base",
     ...
     stations:[
       ...
       {n:6, name:"KB Swings",      time:"120s", rx:"20 reps (20kg)",                sc:"16 reps (12kg)"},
    ...
    {type:"lower", title:"LOWER BODY — Base",
     ...
     stations:[
       ...
       {n:6, name:"KB Swings",       time:"100s", rx:"20 reps (20kg)",                sc:"16 reps (12kg)"},
    ...
    {type:"aerobic", title:"AEROBIC CAPACITY — Base",
     ...
     stations:[
       {n:1, name:"Run",        time:"140s", rx:"300m Zona 2 (conversacional)",  sc:"250m o caminata rápida"},
       {n:2, name:"Rower",      time:"110s", rx:"300m ritmo sostenible",          sc:"220m"},
       {n:3, name:"Wall Balls", time:"100s", rx:"25 reps (6/9kg)",                sc:"18 reps (4/6kg)"},
       ...
       {n:8, name:"KB Swings",  time:"90s",  rx:"20 reps (16kg)",                 sc:"16 reps (12kg)"},
     ],
    ...
    {type:"threshold", title:"THRESHOLD — Base 🔥",
     ...
     stations:[
       {n:1, name:"Run (ANCLA)",  time:"130s", rx:"300m TEMPO pace (RPE 8)",       sc:"250m ritmo fuerte"},
  ...
  w2: [
    ...
    {type:"lower", title:"LOWER BODY — BUILD",
     ...
     stations:[
       {n:1, name:"Run",             time:"110s", rx:"300m Zona 2",                   sc:"250m o caminata rápida"},
    ...
    {type:"aerobic", title:"AEROBIC CAPACITY — BUILD",
     ...
     stations:[
       {n:1, name:"Run",       time:"140s", rx:"300m Zona 2",                     sc:"250m o caminata rápida"},
  ...
  w3: [
    ...
    {type:"aerobic", title:"AEROBIC CAPACITY — PEAK",
     ...
     stations:[
       ...
       {n:3, name:"Wall Balls",time:"100s", rx:"25 reps (6/9kg)",                 sc:"20 reps (4/6kg)"},
       ...
       {n:8, name:"KB Swings", time:"90s",  rx:"20 reps (20kg)",                  sc:"16 reps (16kg)"},
     ],
     cooldown:"5 min: Caminata 200m + stretching pantorrillas y caderas",
    ...
    {type:"threshold", title:"THRESHOLD — PEAK 🔥",
     ...
     stations:[
       {n:1, name:"Run (ANCLA)",  time:"130s", rx:"300m TEMPO (RPE 8-9)",           sc:"250m ritmo fuerte"},
    ...
    {type:"upper", title:"UPPER BODY — PEAK",
     ...
     stations:[
       ...
       {n:6, name:"KB Swings",     time:"120s", rx:"20 reps (24kg)",               sc:"16 reps (16kg)"},
    ...
    {type:"lower", title:"LOWER BODY — PEAK",
     ...
     stations:[
       ...
       {n:6, name:"KB Swings",       time:"100s", rx:"20 reps (24kg)",               sc:"16 reps (16kg)"},
  ...
  w4: [
    ...
    {type:"threshold", title:"THRESHOLD — DELOAD 🔥",
     ...
     stations:[
       {n:1, name:"Run (ANCLA)",  time:"130s", rx:"300m (mismo RPE que PEAK)",      sc:"250m ritmo fuerte"},
       {n:2, name:"Rower",        time:"100s", rx:"320m ritmo agresivo",            sc:"220m"},
    ...
    {type:"lower", title:"LOWER BODY — DELOAD",
     ...
     stations:[
       {n:1, name:"Run",             time:"110s", rx:"300m Zona 2 cómodo",            sc:"250m"},
    ...
    {type:"aerobic", title:"AEROBIC CAPACITY — DELOAD",
     ...
     stations:[
       {n:1, name:"Run",       time:"140s", rx:"300m Zona 2 cómodo",              sc:"250m o caminata rápida"},
